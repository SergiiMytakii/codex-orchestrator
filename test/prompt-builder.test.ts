...
test('package workflow prompts are full bundled workflows, not fallback stubs', async () => {
  ...
  assert.match(prompts.issueBreakdown, /Proof Strategy: auto \/ visual \/ browser-visual \/ mobile-visual \/ non-visual-smoke \/ none/);
  ...
  assert.match(prompts.triage, /Proof Strategy: auto \/ visual \/ browser-visual \/ mobile-visual \/ non-visual-smoke \/ none/);

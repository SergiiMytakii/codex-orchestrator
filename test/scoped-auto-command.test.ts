    ...
    async run(input: CodexCommandRunInput): Promise<CodexCommandRunResult> {
      ...
      await writeFile(
        ...
        JSON.stringify({
          ...
          proofPlan: {
            mode: 'none',
            reason: 'Happy-path fixture does not claim acceptance proof.',
            validationCommands: [],
            requiredArtifacts: [],
          },
          artifacts: [],
    ...
    async run(input: CodexCommandRunInput): Promise<CodexCommandRunResult> {
      ...
      await writeFile(
        ...
        JSON.stringify({
          ...
          proofPlan: {
            mode: 'browser-visual',
            reason: 'Adaptive proof fixture delegates acceptance proof to the proof phase.',
            validationCommands: [],
            requiredArtifacts: [],
    ...
    async run(input: CodexCommandRunInput): Promise<CodexCommandRunResult> {
      ...
      await writeFile(
        ...
        JSON.stringify({
          ...
          proofPlan: {
            mode: 'none',
            reason: 'Fake scoped-agent report does not claim acceptance proof.',
            validationCommands: [],
            requiredArtifacts: [],
          },
          skippedChecks: [],
    ...
    async run(input: CodexCommandRunInput): Promise<CodexCommandRunResult> {
      ...
      await writeFile(
        ...
        JSON.stringify({
          ...
          proofPlan: {
            mode: 'none',
            reason: 'Fixture intentionally omits proof evidence to exercise review-gate repair.',
            validationCommands: [],
            requiredArtifacts: [],
          },
          skippedChecks: [],
    ...
    async run(input: CodexCommandRunInput): Promise<CodexCommandRunResult> {
      ...
      await writeFile(
        ...
        JSON.stringify({
          ...
          proofPlan: {
            mode: 'none',
            reason: 'Quality-gate fixture does not claim acceptance proof.',
            validationCommands: [],
            requiredArtifacts: [],
          },
          artifacts: [],
      ...
      if (input.env?.CODEX_ORCHESTRATOR_REPAIR_MODE === 'evidence') {
        ...
        await writeFile(
          ...
          JSON.stringify({
            ...
            proofPlan: {
              mode: 'none',
              reason: 'Evidence-repair fixture does not claim acceptance proof.',
              validationCommands: [],
              requiredArtifacts: [],
            },
            artifacts: [],
    ...
    async run(input: CodexCommandRunInput): Promise<CodexCommandRunResult> {
      ...
      await writeFile(
        ...
        JSON.stringify({
          ...
          proofPlan: {
            mode: 'none',
            reason: 'Rework-limit fixture does not claim acceptance proof.',
            validationCommands: [],
            requiredArtifacts: [],
          },
          artifacts: [],
    ...
    async run(input: CodexCommandRunInput): Promise<CodexCommandRunResult> {
      ...
      await writeFile(
        ...
        JSON.stringify({
          ...
          proofPlan: {
            mode: 'none',
            reason: 'Structured TDD fixture does not claim acceptance proof.',
            validationCommands: [],
            requiredArtifacts: [],
          },
          artifacts: [],
    ...
    async run(input: CodexCommandRunInput): Promise<CodexCommandRunResult> {
      ...
      await writeFile(
        ...
        JSON.stringify({
          ...
          proofPlan: {
            mode: 'none',
            reason: 'Retry-limit fixture does not claim acceptance proof.',
            validationCommands: [],
            requiredArtifacts: [],
          },
          artifacts: [],
    ...
    async run(input: CodexCommandRunInput): Promise<CodexCommandRunResult> {
      ...
      await writeFile(
        ...
        JSON.stringify({
          ...
          proofPlan: {
            mode: 'none',
            reason: 'Configured-loop fixture does not claim acceptance proof.',
            validationCommands: [],
            requiredArtifacts: [],
          },
          artifacts: [],
    ...
    async run(input: CodexCommandRunInput): Promise<CodexCommandRunResult> {
      ...
      await writeFile(
        ...
        JSON.stringify({
          ...
          proofPlan: {
            mode: 'browser-visual',
            reason: 'UI fixture requires runner-owned browser visual proof.',
            validationCommands: [],
            requiredArtifacts: [],
            visualTarget: 'browser',
          },

...
5. **Apply the outcome:**
   ...
   - `ready-for-human` — same structure as an agent brief, but note why it can't be Runner-routed (judgment calls, external access, design decisions, manual testing).
